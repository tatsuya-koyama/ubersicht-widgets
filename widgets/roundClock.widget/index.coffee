...
<svg version="1.1" id="clock" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 215 215" enable-background="new 0 0 215 215" xml:space="preserve">
  <defs>
    ...
    -->
    <marker id="min-mk" markerHeight="30" markerWidth="115" refX="50" refY="15" orient="auto">
      <polygon points="0,10 0,20 65,15"/>
    </marker>
    <marker id="hr-mk" markerHeight="30" markerWidth="15" refX="10" refY="15" orient="auto">
      <polygon points="0,0 0,30 15,15"/>
    </marker>
  </defs>

  <path id="min-ln" stroke-width="3" stroke-miterlimit="10" d="M107.5,7.5c55.2,0,100,44.8,100,100s-44.8,100-100,100s-100-44.8-100-100S52.3,7.5,107.5,7.5"/>

  <line id="min-ln2" class="line" marker-end="url(#min-mk)" stroke-miterlimit="10" x1="107" y1="107.5" x2="107" y2="24.5"/>
...
<div id="digits">
  <span id="hr-dig">0</span><span id="min-dig">00</span><div id="sec-dig"></div>
</div>
"""
...
update: (output) ->
  ...
  $('#min-ln2').css('-webkit-transform','rotate('+( ( parseInt(time[1]) + ( time[2] / 60 ) ) / 60 ) * 360+'deg)')
